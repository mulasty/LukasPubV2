  ...
  return (
    <StorySection id="rezerwacja">
      <div className="glass-card relative overflow-hidden rounded-[2.5rem] p-7 sm:p-10" data-reveal>
        <div data-parallax data-speed="-0.16" className="absolute -left-16 top-0 h-48 w-48 rounded-full bg-fuchsia-500/20 blur-3xl" />
        <div data-parallax data-speed="0.18" className="absolute bottom-0 right-0 h-56 w-56 rounded-full bg-cyan-300/16 blur-3xl" />
